...
%Example usage:
% OutcomePlot(AxesHandle,'init',TrialTypes)
% OutcomePlot(AxesHandle,'init',TrialTypes,'ntrials',90)
% OutcomePlot(AxesHandle,'update',CurrentTrial,TrialTypes,OutcomeRecord)
...
% Kachi O. 2014.Mar.17
% Josh S. 2015.Jun.6 - adapted to display trial types instead of sides
