    ...
    case 'init'
        ...
        if nCandidates > 0
            for x = 1:nCandidates
                ...
                try
                    CandidateDevice = PsychPortAudio('Open', CandidateDevices(x), 9, 4, SF, 2 , 64);
        ...
        BpodSystem.PluginObjects.SoundServer.MasterOutput = PsychPortAudio('Open', BpodSystem.SystemSettings.SoundDeviceID, 9, 4, SF, 2 , 64);
