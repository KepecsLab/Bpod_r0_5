...
TrialTypes = [ones(1,nDirectDeliveryTrials) ones(1,nPreSoundTrials)*2 ones(1,nPreSoundTrials)*3 ones(1,nPreSoundTrials)*4 ceil(rand(1,1000)*4)];
...
for currentTrial = 1:MaxTrials
    ...
    sma = AddState(sma, 'Name', 'WaitForResponse', ...
        'Timer', 2,...
        'StateChangeConditions', {'Port1In', 'LeftReward', 'Port3In', 'RightReward', 'Tup', 'Blah'},...
    ...
    sma = AddState(sma, 'Name', 'ConfirmPortOut', ...
        ...
        'OutputActions', {});
    sma = AddState(sma, 'Name', 'Blah', ...
        'Timer', 1,...
        'StateChangeConditions', {'Tup', 'exit', 'Port1In', 'Hell'},...
        'OutputActions', {});
    sma = AddState(sma, 'Name', 'Hell', ...
        'Timer', 0,...
...
for x = 1:Data.nTrials
    if ~isnan(Data.RawEvents.Trial{x}.States.Hell(1))
        Outcomes(x) = 0;
    elseif ~isnan(Data.RawEvents.Trial{x}.States.Drinking(1))
        Outcomes(x) = 1;
    else
        Outcomes(x) = 3;
    end
